-- ============================================================
-- Migration: Fix Place Order Schema Mismatch
-- - Completely updates place_order_secure to support modern schema
-- - Properly rounds money to INTEGER values due to schema architecture
-- ============================================================
